 ...
 * com.cg.learning.Calculator. For now, the service service is published at
 * network address 127.0.0.1., which is localhost, and at port number 9876, as
 * this port is likely available on any desktop machine. The publication path is
 * /cs, an arbitrary name.
 *
...
public class ProductPublisher {
	public static void main(String[] args) {
		...
		Endpoint.publish("http://127.0.0.1:8087/ps", new ProductService());
	}
}
